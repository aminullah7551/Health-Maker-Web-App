	...
	<div class="col-md-12 box box-default">		
		<div class="box-header">
			<section class="content-header">
			  ...
			  <ol class="breadcrumb">
				<a href="<?php echo $this->Health->createurl("Activity","activityList");?>" class="btn btn-flat btn-custom"><i class="fa fa-bars"></i> <?php echo __("Activity List");?></a>
			  </ol>
			</section>
		</div>
		<hr>
		...
		<div id="video" style="display: none;" class="video_div video_div_empty">			
			...
			<div class='form-group'>
				...
				<div class="col-md-2">
					<button class="form-control add_category btn btn-default btn-flat" type="button" data-url="<?php echo $this->Health->createurl("HealthAjax","addCategory"); ?>"><?php echo __("Add Category");?></button>
				</div>
			</div>
			<div class='form-group'>
