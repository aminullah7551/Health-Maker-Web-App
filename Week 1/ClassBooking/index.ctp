...
<section class="content">
	...
	<div class="col-md-12 box box-default">		
		...
		<?php				
			...
			echo $this->Form->input("",["label"=>false,"name"=>"booking_date","class"=>"form-control dob validate[required] datepick","value"=>(($edit)?date($this->Health->getSettings("date_format"),strtotime($data['booking_date'])):''),"onkeydown"=>"return false",'id'=>'booking_date',"autocomplete"=>"off"]);
			echo "</div>";
			echo "</div>";
			echo "</fieldset>";
