...
$header_color = $this->Health->getHeaderColor();
$sidemenu_color = $this->Health->getSidemenuColor();
                ...
                <ul class="dropdown-menu">
				  ...
				  echo $this->Html->image("../webroot/upload/{$user_img}",array("class"=>"img-circle","alt"=>"User Image")); ?>
                    <p>
                      ...
                      <small><?php echo __("Member since"); ?> <?php echo $this->Health->get_db_format(date("F 'y",strtotime($session->read("User.join_date"))));?></small>
                    </p>
                  </li>
				 ...
				 <?php  
                    ...
                    <div class="pull-left">                     
					  <a href="<?php echo $this->request->base; ?>/HealthProfile/viewProfile" class="btn btn-default btn-flat"><?php echo __("Profile"); ?></a>
					</div>
				  <?php } ?>	
