<head>
   <?= $this->Html->charset() ?>
	...
	<?php 
		...
		echo $this->Html->css('health_custom');
		echo $this->Html->css('health_responsive'); 
...
<input type="hidden" id="get_language_ajax_path" value="<?php echo $this->Health->createurl('HealthAjax','getSystemLanguage');?>">
<script src="https://www.gstatic.com/charts/loader.js"></script>
<input type="hidden" id="getchartjs_path" value="<?php echo $this->Health->createurl('HealthAjax','getchartjs'); ?>">
		<?php
		$sys_lang = $this->Health->getSettings("sys_language");
		echo $this->Html->script('app.min.js');
		echo $this->Html->script('validationEngine/languages/jquery.validationEngine-'.$sys_lang);
		echo $this->Html->script('validationEngine/jquery.validationEngine'); 
		echo $this->Html->script('health_ajax'); 
