	...
	<div id="main-wrapper">		
		<div class="row"><!-- Start Row2 -->
			<div class="left_section col-md-8 col-sm-8">
				<?php
				$access = $this->Health->get_member_accessright('member');
				if($access == 1)
				{
				?>
				...
				$access = $this->Health->get_member_accessright('staff_member');
				if($access == 1)
				{
				?>
					<div class="col-lg-3 col-md-3 col-xs-6 col-sm-6">
				...
				$access = $this->Health->get_member_accessright('group');
				if($access == 1)
				{
				?>
					<div class="col-lg-3 col-md-3 col-xs-6 col-sm-6">
				...
				$access = $this->Health->get_member_accessright('message');
				if($access == 1)
				{
				?>
					<div class="col-lg-3 col-md-3 col-xs-6 col-sm-6">
			...
			<div class="col-md-4 membership-list <?php echo $pull;?> col-sm-4 col-xs-12">
				<?php
				$access = $this->Health->get_member_accessright('membership');
				if($access == 1)
				{
				?>
