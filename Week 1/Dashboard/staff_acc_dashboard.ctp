		...
		<div class="row">
			...
			<div class="left_section col-md-8 col-sm-8">
				...
				if ($session_user["role_name"] == "staff_member")
					$access = $this->Health->get_staff_member_accessright('member');
				else
					$access = $this->Health->get_accountant_accessright('member');
				...
				if ($session_user["role_name"] == "staff_member")
					$access = $this->Health->get_staff_member_accessright('staff_member');
				else
					$access = $this->Health->get_accountant_accessright('staff_member');
				...
				if ($session_user["role_name"] == "staff_member")
					$access = $this->Health->get_staff_member_accessright('group');
				else
					$access = $this->Health->get_accountant_accessright('group');
				...
				if ($session_user["role_name"] == "staff_member")
					$access = $this->Health->get_staff_member_accessright('message');
				else
					$access = $this->Health->get_accountant_accessright('message');
			...
			<div class="col-md-4 membership-list <?php echo $pull; ?> col-sm-4 col-xs-12">
				<?php
				if ($session_user["role_name"] == "staff_member")
					$access = $this->Health->get_staff_member_accessright('membership');
				else
					$access = $this->Health->get_accountant_accessright('membership');
