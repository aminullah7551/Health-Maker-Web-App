...
<section class="content">
	...
	<div class="col-md-12 box box-default">		
			...
			<div class="col-md-8">
				...
				if($session["role_name"] == 'member')
				{
					...
					{ ?>
						...
						<label class="control-label" id="mem_list" data-url="<?php echo $this->request->base;?>/HealthAjax/getWorkoutDates"><?php echo $value;?></label>
					<?php
					}
				}
				else{
					echo $this->Form->select("member_id",$members,["default"=>($edit)?$this->request->params["pass"]:"","empty"=>__("Select Member"),"class"=>"mem_list","required"=>"true","id"=>"mem_list","data-url"=>$this->request->base ."/HealthAjax/getWorkoutDates"]);
				}
				?>
			</div>
			<?php 
		...
		<div class="form-group">
			...
			<div class="col-md-8" id="paginator" data-url=<?php echo $this->request->base ."/HealthAjax/healthWorkoutData";?>>
