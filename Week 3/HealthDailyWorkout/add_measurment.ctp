...
$(document).ready(function(){
	...
	<?php if($edit){ ?>
	$( ".date" ).datepicker( "setDate", new Date("<?php echo date($this->Health->getSettings("date_format"),strtotime($data['result_date'])); ?>" ));
	<?php } ?>
...
<section class="content">
		...
		<div class="box-header">
			<section class="content-header">
			  ...
			  <ol class="breadcrumb">
				...
				&nbsp;
				<a href="<?php echo $this->Health->createurl("HealthDailyWorkout","addWorkout");?>" class="btn btn-flat btn-custom"><i class="fa fa-plus"></i> <?php echo __("Add Workout");?></a>
			  </ol>
			</section>
		</div>
		<hr>
	...
	<?php } ?>
		...
		<div class='form-group'>
			...
			<div class="col-md-8">
				<?php echo $this->Form->input("",["autocomplete"=>"off","label"=>false,"class"=>"form-control date validate[required]","name"=>"result_date","value"=>($edit)?date($this->Health->getSettings("date_format"),strtotime($data["result_date"])):""]); ?>
			</div>
		</div>
		<div class='form-group'>
