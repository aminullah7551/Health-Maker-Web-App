...
Class ClassBookingController  extends AppController
{
				...
				if($data['payment_by'] == 'Stripe'){
					...
					if(!empty($this->request->data['stripeToken'])) {
						  	...
						  	) 
						{
							...
							$data['booking_date'] = $this->HEALTHFunction->get_db_format_date($this->request->data['booking_date']);
					...
					if($booking != NULL){
						...
						$this->request->data['booking_date'] = $this->HEALTHFunction->get_db_format_date($this->request->data['booking_date']);
	...
	public function paymentSuccess()
	{
		...
		$payment_data['booking_date'] = $this->HEALTHFunction->get_db_format_date($payment_data['booking_date']);
