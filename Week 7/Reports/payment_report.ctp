...
<section class="content">
	...
	<div class="col-md-12 box box-default">		
		<div class="box-header box_payment">
			<section class="content-header bread_payment">
				...
				<ol class="breadcrumb">
					...
					&nbsp;
					<a href="<?php echo $this->Health->createurl("Reports","paymentReport");?>" class="btn active btn-flat btn-custom"><i class="fa fa-bar-chart"></i> <?php echo __("Payment Report");?></a>
					&nbsp;
		...
		<div class="box-body">
			<?php 
			$options = Array(
				'title' => __('Fee Payment Report By Month','health_mgt'),
				...
				'hAxis' => Array(
					'title' => __('Month','health_mgt'),
					'titleTextStyle' => Array('color' => '#66707e','fontSize' => 14,'bold'=>true,'italic'=>false,'fontName' =>'open sans'),
					'textStyle' => Array('color' => '#66707e','fontSize' => 11),
					'maxAlternation' => 2
					),
				'vAxis' => Array(
					'title' => __('Fee Payment','health_mgt'),
					 'minValue' => 0,
					'maxValue' => 5,
					 'format' => '#',
					'titleTextStyle' => Array('color' => '#66707e','fontSize' => 14,'bold'=>true,'italic'=>false,'fontName' =>'open sans'),
