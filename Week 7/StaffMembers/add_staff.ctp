...
$(document).ready(function() {
	...
	$(".date").datepicker( "option", "dateFormat", "<?php echo $this->Health->dateformat_PHP_to_jQueryUI($this->Health->getSettings("date_format")); ?>" );
	<?php
	if($edit)
	{
	...
	<div class="col-md-12 box box-default">
		<div class="box-header">
			<section class="content-header">
			  ...
			  <ol class="breadcrumb">
				<a href="<?php echo $this->Health->createurl("StaffMembers","StaffList");?>" class="btn btn-flat btn-custom"><i class="fa fa-bars"></i> <?php echo __("Staff Member List");?></a>
			  </ol>
			</section>
		</div>
		<hr>
		<div class="box-body">
			...
			echo '<div class="col-md-6">';
			echo $this->Form->input("",["autocomplete"=>"off","label"=>false,"name"=>"birth_date","class"=>"form-control dob date validate[required]","value"=>(($edit)?date($this->Health->getSettings("date_format"),strtotime($data['birth_date'])):'')]);
			echo "</div>";
			echo "</div>";
			...
			echo "<a href='javascript:void(0)' class='add-role btn btn-flat btn-success' data-url='{$this->Health->createurl("HealthAjax","addRole")}'>".__("Add/Remove")."</a>";
			echo "</div>";
			echo "</div>";
			...
			echo "&nbsp;&nbsp;&nbsp;&nbsp;<a href='javascript:void(0)' class='add-spec btn btn-flat btn-success' data-url='{$this->request->base}/HealthAjax/AddSpecialization'>".__("Add/Remove")."</a>";
			echo "</div>";
			echo "</div>";
			echo "</fieldset>";
