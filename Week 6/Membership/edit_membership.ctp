<section class="content">
	...
	<div class="col-md-12 box box-default">		
		...
		<?php
			...
			echo $this->Form->create($membership,["id"=>"form","type"=>"file","class"=>"validateForm"]);
			...
			echo $this->Form->button("Update Membership",['class'=>"btn btn-primary submit_button","name"=>"add_membership"]);
			echo $this->Form->end();
