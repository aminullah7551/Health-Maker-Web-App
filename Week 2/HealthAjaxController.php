...
Class HealthAjaxController extends AppController

{
				...
				<div class="row">
					...
					<div class="col-sm-12 col-md-6">
						...
						<div class="col-md-7 col-sm-6">
							...
							<label class="book"><?php echo $this->HEALTHFunction->get_class_by_id($data['class_id'])?></label>
						...
						<div class="col-md-7 col-sm-6">
							...
							$issue_date= $this->HEALTHFunction->get_db_format_en_lang(date($sys_data['date_format'],strtotime($issue_date))); ?>
						...
						<div class="col-md-7 col-sm-6">
							...
							<label class="book"><?php echo $this->HEALTHFunction->get_currency_symbol($this->HEALTHFunction->getSettings('currency')); echo $data['booking_amount'] != ''?$data['booking_amount']:'0' ?></label>
		...
		?>	
			...
			<div class="modal-body">
				<div class="row">
					...
					<div class="col-sm-4">
						<button class="add-category btn btn-flat btn-success" data-url="<?php echo $this->request->base."/HealthAjax/saveCategory";?>"><?php echo  __("Add Category");?></button>
					</div>
				</div>
				<hr>
				<div class="row">
							...
							<?php
								foreach($categories as $category) {
									echo "<tr id='row-{$category->id}'>
										<td>{$category->name}</td>
										<td><button class='del-category btn btn-flat btn-danger' del-id='{$category->id}' data-url='{$this->request->base}/HealthAjax/deleteCategory'>".__("Delete")."</button></td>
									</tr>";
								}
							?>
							</tbody>
	...
	public function saveCategory() {
		...
		if($category_table->save($category)) {
			$id = $category->id;
			$return[0] = "<tr id='row-{$id}'><td>{$name}</td><td><button del-id='{$id}' class='del-category btn btn-flat btn-danger' data-url='{$this->request->base}/HealthAjax/deleteCategory'>".__("Delete")."</button></td></tr>";
	...
	public function addInstalmentPlan() {
		...
		<div class="modal-body">
			<div class="row">
				...
				<div class="col-sm-2">
					<button class="add-plan btn btn-flat btn-success" data-url="<?php echo $this->request->base."/HealthAjax/savePlan";?>"><?php echo  __("Add Category");?></button>
				</div>
			</div>
			<hr>
			<div class="row">
						...
						<tbody>
							...
							foreach($plans as $plan) {
								echo "<tr id='row-{$plan->id}'>
									...
									<td><button class='del-plan btn btn-flat btn-danger' del-id='{$plan->id}' data-url='{$this->request->base}/HealthAjax/deletePlan'>".__("Delete")."</button></td>
									</tr>";
							}
							?>
						</tbody>
	...
	public function savePlan() {
		...
		if($plan_table->save($plan)) {
			$id = $plan->id;
			$return[0] = "<tr id='row-{$id}'><td>{$number} {$duration}</td><td><button del-id='{$id}' class='del-plan btn btn-flat btn-danger' data-url='{$this->request->base}/HealthAjax/deletePlan'>".__("Delete")."</button></td></tr>";
...

	{
		...
		$role_table = TableRegistry::get("HealthRoles");
			...
			<div class="row">
				...
				<form class="validateForm">
					...
					<div class="col-sm-4">
						...
						<button class="save-role btn btn-flat btn-success" data-url="<?php echo $this->request->base."/HealthAjax/saveRole";?>"><?php echo  __("Add Role");?></button>
					...
					<table class="table" id="roles_list">
...

						{
...

							{
								...
								<td><button class='del-role btn btn-flat btn-danger' del-id='{$role->id}' data-url='{$this->request->base}/HealthAjax/deleteRole/{$role->id}'>".__("Delete")."</button></td>
...

	{
...

		{
			...
			$return[0] = "<tr id='row-{$id}'><td>{$name}</td><td><button del-id='{$id}' class='del-role btn btn-flat btn-danger' data-url='{$this->request->base}/HealthAjax/deleteRole/{$id}'>".__("Delete")."</button></td></tr>";
			...
			<div class="modal-body">
				...
				<div class="row">
					...
					<div class="col-sm-4">
						...
						<button class="save-spec btn btn-flat btn-success" data-url="<?php echo $this->request->base."/HealthAjax/saveSpecialization";?>"><?php echo  __("Add Role");?></button>
							...
							<?php
...

								{
...

									{
										...
										<td><button class='del-spec btn btn-flat btn-danger' del-id='{$spec->id}' data-url='{$this->request->base}/HealthAjax/deleteSpecialization/{$spec->id}'>".__("Delete")."</button></td>
...

	{
...

		{
			...
			$return[0] = "<tr id='row-{$id}'><td>{$name}</td><td><button del-id='{$id}' class='del-spec btn btn-flat btn-danger' data-url='{$this->request->base}/HealthAjax/deleteSpecialization/{$id}'>".__("Delete")."</button></td></tr>";
...

	{
		...
		$interest_table = TableRegistry::get("HealthInterestArea");
		...
		<div class="modal-body">
			...
			<div class="row">
				...
				<div class="col-sm-4">
					...
					<button class="save-interest btn btn-flat btn-success" data-url="<?php echo $this->request->base."/HealthAjax/saveInterest";?>"><?php echo  __("Add Interest");?></button>
					...
					<table class="table" id="interest_list">
...

						{
...

							{
								...
								<td><button class='del-interest btn btn-flat btn-danger' del-id='{$row->id}' data-url='{$this->request->base}/HealthAjax/deleteInterest/{$row->id}'>".__("Delete")."</button></td>
...

	{
...

		{
			...
			$return[0] = "<tr id='row-{$id}'><td>{$interest}</td><td><button del-id='{$id}' class='del-interest btn btn-flat btn-danger' data-url='{$this->request->base}/HealthAjax/deleteInterest/{$id}'>".__("Delete")."</button></td></tr>";
...

	{
		...
		$interest_table = TableRegistry::get("healthSource");
		...
		<div class="modal-body">
			...
			<div class="row">
				...
				<div class="col-sm-4">
					...
					<button class="save-source btn btn-flat btn-success" data-url="<?php echo $this->request->base."/HealthAjax/saveSource";?>"><?php echo  __("Add Source");?></button>
					...
					<table class="table" id="source_list">
...

						{
...

							{
								...
								<td><button class='del-source btn btn-flat btn-danger' del-id='{$row->id}' data-url='{$this->request->base}/HealthAjax/deleteSource/{$row->id}'>".__("Delete")."</button></td>
...

	{
		...
		$source_table = TableRegistry::get("healthSource");
...

		{
			...
			$return[0] = "<tr id='row-{$id}'><td>{$source}</td><td><button del-id='{$id}' class='del-source btn btn-flat btn-danger' data-url='{$this->request->base}/HealthAjax/deleteSource/{$id}'>".__("Delete")."</button></td></tr>";
...

	{
		...
		$format = $this->HEALTHFunction->date_format();
		...
		$date1 = $this->HEALTHFunction->get_db_format_date($this->request->data['date']);
		...
		$end_date =  $this->HEALTHFunction->get_db_format_date($date1 . " + {$period} days");
	...
	public function levelsList() {
		$level_table = TableRegistry::get("HealthLevels");
		...
		<div class="modal-body">
			<div class="row">
				...
				<div class="col-sm-4">
					<button class="save-level btn btn-flat btn-success" data-url="<?php echo $this->request->base."/HealthAjax/saveLevel";?>"><?php echo  __("Add Level");?></button>
				</div>
			</div>
			<hr>
			<div class="row">
						...
						<?php
							if(!empty($levels)) {
								foreach($levels as $row) {
									echo "<tr id='row-{$row->id}'>
									<td>{$row->level}</td>
									<td><button class='del-level btn btn-flat btn-danger' del-id='{$row->id}' data-url='{$this->request->base}/HealthAjax/deleteLevel/{$row->id}'>".__("Delete")."</button></td>
									</tr>";
								}
	...
	public function saveLevel()	{
		...
		if($level_table->save($row)) {
			$id = $row->id;
			$return[0] = "<tr id='row-{$id}'><td>{$level}</td><td><button del-id='{$id}' class='del-level btn btn-flat btn-danger' data-url='{$this->request->base}/HealthAjax/deleteLevel/{$id}'>".__("Delete")."</button></td></tr>";
...

	{
		...
		$workour_data_table = TableRegistry::get("HealthWorkoutData");

		if($workour_data_table->deleteAll(["workout_id"=>$id]))

		{

			$assign_table = TableRegistry::get("HealthAssignWorkout");
	...
	public function healthWorkoutData()

	{
		...
		$sel_date=$this->HEALTHFunction->get_db_format_date($this->request->data['sel_date']);

		

		$health_member_table = TableRegistry::get("health_member");

		$membership_table = TableRegistry::get("membership");

		$health_member_data = $health_member_table->get($uid);

		$membership_id = $health_member_data->selected_membership;
		...
		$daily_table = TableRegistry::get("HealthDailyWorkout");

		$user_workout_table = TableRegistry::get("HealthUserWorkout");
		...
		$workout_table = TableRegistry::get("HealthWorkoutData");
		...
		$sql = "SELECT * FROM `health_assign_workout` as workout,`health_workout_data` as workoutdata WHERE  workout.user_id = {$uid} 
		...
		if(!empty($results)){
			...
			echo "<div class='col-md-12' id='membership_cat_id' value='".$membership_cat_id."' style='padding-left: 0px;padding-bottom: 15px;'>". __('Membership Plan Category') .": ".$this->HEALTHFunction->get_category_name($membership_cat_id)."</div>";
			...
			<div class='col-md-12' id='membership_cat_id' value='".$membership_cat_id."' style='padding-left: 0px;padding-bottom: 15px;'>". __('Membership Plan Category') .": ".$this->HEALTHFunction->get_category_name($membership_cat_id)."</div>
			...
			<div class='form-group'>
				...
				<div class="col-md-6">
					...
					<select class="form-control level_list validate[required]" name="level_id">
						...
						$levels_table = TableRegistry::get("HealthLevels");
				...
				<div class="col-md-3">
					...
					<a href="javascript:void(0);" class="btn btn-default btn-flat level-list" data-url="<?php echo $this->request->base;?>/HealthAjax/levelsList"><?php echo __("Add Level");?></a>
	...
	public function getWorkoutDates() {
		...
		$assign_table = TableRegistry::get("HealthAssignWorkout");
		$data = $assign_table->find()->where(["user_id"=>$uid])->select(["HealthAssignWorkout.id","HealthAssignWorkout.start_date","HealthAssignWorkout.end_date"])->hydrate(false)->toArray();
		...
		if(!empty($data)) {
			...
			foreach($data as $rec){
				...
				$date_rages[$x]["start_date"]=$this->HEALTHFunction->get_db_format_date($rec["start_date"]);
				$date_rages[$x]["end_date"]=$this->HEALTHFunction->get_db_format_date($rec["end_date"]);
	...
	public function HealthViewMeasurment()

	{
...

		{
			...
			$measurment_table = TableRegistry::get("HealthMeasurement");
						...
						<table class="table" id="level_list">
...

							{
...

								{
									...
									//echo $this->Health->get_db_format(date($this->Health->getSettings("date_format"),strtotime($row['result_date'])));
									...
									echo "<tr id='row_{$row['id']}'>
										...
										<td>".$this->HEALTHFunction->get_db_format_en_lang(date($this->HEALTHFunction->getSettings("date_format"),strtotime($row['result_date'])))."</td>

										<td>

										<a href='".$this->request->base ."/HealthDailyWorkout/editMeasurment/{$row['id']}' class='btn btn-flat btn-primary' title='".__('Edit')."'><i class='fa fa-edit'></i></a>

										<a href='javascript:void(0)' data-url='{$this->request->base}/HealthAjax/deleteMeasurment/{$row['id']}' class='delete_measurment btn btn-flat btn-danger view-measurement-popup' did='{$row['id']}' title='".__('Delete')."'><i class='fa fa-trash'></i></a>      
...

	{
...

		{
			...
			$measurement_table = TableRegistry::get("HealthMeasurement");			
...

	{
		...
		$nutrition_data_table = TableRegistry::get("HealthNutritionData");

		if($nutrition_data_table->deleteAll(["nutrition_id"=>$id]))

		{

			$nutrition_table = TableRegistry::get("HealthNutrition");
	...
	public function EventPlaceList() {
		$event_tbl = TableRegistry::get("HealthEventPlace");
		...
		<div class="modal-body">
			<div class="row">
				...
				<div class="col-sm-4">
					<button class="save-event-place btn btn-flat btn-success" data-url="<?php echo $this->request->base."/HealthAjax/saveEventPlace";?>"><?php echo  __("Add Place"); ?></button>
				</div>
			</div>
			<hr>
			<div class="row">
					...
					<table class="table" id="events_place_list">
						...
						if(!empty($event_places)) {
							foreach($event_places as $place) {
								...
								<td>{$place->place}</td>
								<td><button class='del-event-place btn btn-flat btn-danger' del-id='{$place->id}' data-url='{$this->request->base}/HealthAjax/deleteEventPlace/{$place->id}'>".__("Delete")."</button></td>
								</tr>";
							}
						}else {
	...
	public function saveEventPlace() {
		if($this->request->is("ajax")) {
			...
			if($event_tbl->save($row)) {
				$id = $row->id;
				$return[0] = "<tr id='row-{$id}'><td>{$place_name}</td><td><button del-id='{$id}' class='del-event-place btn btn-flat btn-danger' data-url='{$this->request->base}/HealthAjax/deleteEventPlace/{$id}'>".__("Delete")."</button></td></tr>";
	...
	public function viewGroupMember($gid) {
		if($this->request->is("ajax")) {
			$grp_tbl = TableRegistry::get("HealthMember");
	...
	public function healthPay($mp_id,$due) {
		$this->loadComponent("HEALTHFunction");
			...
			$(document).ready(function(){
				...
				$("#payment_method").on('change',function(){
					...
					if(payment == 'Stripe'){
						...
						var api_key = "<?php echo $this->HEALTHFunction->getSettings('stripe_publishable_key'); ?>"
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				<div class='input-group'>
					<span class='input-group-addon'><?php echo $this->HEALTHFunction->get_currency_symbol();?></span>
		...
		<div class="col-sm-offset-2 col-sm-8">
			...
			<div class="stripe">
	        	 <script src="https://checkout.stripe.com/checkout.js" class="stripe-button"
		          data-key="<?php echo $this->HEALTHFunction->getSettings('stripe_publishable_key'); ?>"
	...
	public function viewInvoice($mp_id) {
		...
		$type = 'invoice';
		$sys_data = $setting_tbl->find()->select(["name","address","health_logo","date_format","office_number","country"])->hydrate(false)->toArray();
		$sys_data[0]["health_logo"] = (!empty($sys_data[0]["health_logo"])) ? $this->request->base . "/webroot/upload/".  $sys_data[0]["health_logo"] : $this->request->base . "/webroot/img/Thumbnail-img.png";
		$data = $payment_tbl->find("all")->contain(["HealthMember","Membership"])->where(["mp_id"=>$mp_id])->hydrate(false)->toArray();
		...
		<table width="100%" border="0">
			<tbody>
				<tr>
					<td width="70%">
						<img style="max-height:80px;" src="<?php echo $sys_data[0]["health_logo"]; ?>">
					</td>
					<td align="right" width="24%">
						<h5><?php echo __('Invoice Number')." : ". $data[0]['mp_id'];?></h5>
						<h5><?php $issue_date=$data[0]['created_date']->format("Y-m-d");
							$issue_date= $this->HEALTHFunction->get_db_format_en_lang(date($sys_data[0]['date_format'],strtotime($issue_date)));
							echo __('Issue Date')." : ". $issue_date;?></h5>
						<h5><?php echo __('Status')." : "; 
						if($this->HEALTHFunction->get_membership_paymentstatus($mp_id) == "Fully Paid") {
						echo "<span style='cursor:default;' class='btn btn-success btn-xs'>";
							echo __($this->HEALTHFunction->get_membership_paymentstatus($mp_id));
							echo "</span>";
						}
						if($this->HEALTHFunction->get_membership_paymentstatus($mp_id) == "Partially Paid") {
						echo "<span style='cursor:default;' class='btn btn-primary btn-xs'>";
							echo __($this->HEALTHFunction->get_membership_paymentstatus($mp_id));
							echo "</span>";
						}
						if($this->HEALTHFunction->get_membership_paymentstatus($mp_id) == "Not Paid") {
			...
			<tbody>
				...
				<tr>
					...
					<td valign="top" align="<?php echo $float_r;?>">
						...
						echo $data[0]["health_member"]["first_name"]." ".$data[0]["health_member"]["last_name"]."<br>"; 
						echo $data[0]["health_member"]["address"].","; 
						echo $data[0]["health_member"]["city"].","; 
						echo $data[0]["health_member"]["zipcode"].",<BR>"; 
						echo $data[0]["health_member"]["state"].","; 
						echo $sys_data[0]["country"].","; 
						echo $data[0]["health_member"]["mobile"]."<br>"; 
						?>
					</td>
				</tr>
			</tbody>
		...
		<table class="table table-bordered" width="100%" border="1" style="border-collapse:collapse;">
			...
			<!-- <td class="text-center"><?php echo $this->HEALTHFunction->get_currency_symbol();?> <?php echo $data[0]["membership"]["signup_fee"];?></td> -->
				<td class="text-center"><?php echo $this->HEALTHFunction->get_currency_symbol();?> <?php echo $data[0]["membership"]["membership_amount"];?></td>
				<td class="text-center"><?php echo $this->HEALTHFunction->get_currency_symbol();?> <?php echo $subtotal = intval($data[0]["membership"]["membership_amount"]) /* + intval($data[0]["membership"]["signup_fee"]);*/ ?></td>
			</tbody>
		</table>
		<table width="100%" border="0">
			<tbody>
				<tr>
					...
					<td align="<?php echo $float_r;?>"><?php echo $this->HEALTHFunction->get_currency_symbol();?> <?php echo $subtotal;?></td>
				</tr>
				<tr>
					<td width="80%" align="<?php echo $float_r;?>"><?php echo __('Payment Made :');?></td>
					<td align="<?php echo $float_r;?>"><?php echo $this->HEALTHFunction->get_currency_symbol();?> <?php echo $data[0]["paid_amount"];?></td>
				</tr>
				<tr>
					<td width="80%" align="<?php echo $float_r;?>"><?php echo __('Due Amount  :');?></td>
					<td align="<?php echo $float_r;?>"><?php echo $this->HEALTHFunction->get_currency_symbol();?> <?php echo $subtotal - $data[0]["paid_amount"];?></td>
				</tr>
			</tbody>			
		</table>
		<hr>
		...
		<thead>
			...
			<tbody>
				...
				{?>
					<tr>
					<td class="text-center"><?php echo $this->HEALTHFunction->get_db_format_en_lang(date($this->HEALTHFunction->getSettings("date_format"),strtotime($retrive_date["paid_by_date"])));?></td>
					<td class="text-center"><?php echo $this->HEALTHFunction->get_currency_symbol();?> <?php echo $retrive_date["amount"];?></td>
...

	{
		...
		$in_ex_table = TableRegistry::get("HealthIncomeExpense");

		$setting_tbl = TableRegistry::get("GeneralSetting");	

		$mem_tbl = TableRegistry::get("HealthMember");	
...

		{
			...
			$data = $in_ex_table->find("all")->contain(["HealthMember"])->where(["HealthIncomeExpense.id"=>$id])->hydrate(false)->toArray();

		}

		else if($type == "expense"){

			$data = $in_ex_table->find("all")->where(["HealthIncomeExpense.id"=>$id])->select($in_ex_table);

			$data = $data->rightjoin(["HealthMember"=>"health_member"],

									["HealthIncomeExpense.receiver_id = HealthMember.id"])->select($mem_tbl)->hydrate(false)->toArray();

			$data[0]["health_member"] = $data[0]["HealthMember"];
						...
						<?php
							...
							{ ?>
								...
								<tr>
									...
									<td class="text-center"><?php echo $this->HEALTHFunction->get_db_format_en_lang(date($this->HEALTHFunction->getSettings("date_format"),strtotime($data[0]["invoice_date"])));?></td>

									<td class="text-center"><?php echo $entry->entry;?></td>

									<td class="text-center"><?php echo $this->HEALTHFunction->get_currency_symbol();?>  <?php echo $entry->amount;?></td>

									<td class="text-center"><?php echo $data[0]["health_member"]["first_name"] . " ". $data[0]["health_member"]["last_name"];?></td>
				...
				<table width="100%" border="0">
					...
					<tbody>
						...
						<tr>
							...
							<td><?php echo "  ".$this->HEALTHFunction->get_currency_symbol();?>  <?php echo $data[0]["total_amount"];?></td>
...

	{
...

		{
			...
			$notice_tbl = TableRegistry::get("HealthNotice");
			...
			<div class="modal-body">		
				...
				<div class="panel panel-white form-horizontal">
				  ...
				  <div class="form-group">
					...
					<div class="col-sm-9"> <?php echo  $this->HEALTHFunction->get_db_format_en_lang(date($this->HEALTHFunction->getSettings("date_format"),strtotime($row["start_date"]))); ?></div>
				  ...
				  <div class="form-group">
					...
					<div class="col-sm-9"> <?php echo $this->HEALTHFunction->get_db_format_en_lang(date($this->HEALTHFunction->getSettings("date_format"),strtotime($row["end_date"]))); ?> </div>
	...
	public function getCategoriesByMember() {
		if($this->request->is("ajax")) {
			...
			$member_tbl = TableRegistry::get("health_member");
	...
	public function getSystemLanguage() {
        echo $this->HEALTHFunction->getSettings('sys_language');
    }
}