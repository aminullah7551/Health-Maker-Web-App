...
class HealthAccessrightController extends AppController
{
	public function accessRight()
    {
		$rights = $this->HealthAccessright->find("all")->hydrate(false)->toArray();
		...
		{			
			...
			'page_link'=>$site_path.'/health-group/group-list',
			'controller'=>"HealthGroup");
			...
			'page_link'=>$site_path.'/health-member/member-list',
			'controller'=>"HealthMember");
			...
			'page_link'=>$site_path.'/health-attendance/attendance',
			'controller'=>"HealthAttendance");
			...
			'page_link'=>$site_path.'/health-assign-workout/workout-log',
			'controller'=>"HealthAssignWorkout");
			...
			'page_link'=>$site_path.'/health-daily-workout/workout-list',
			'controller'=>"HealthDailyWorkout");
			...
			'page_link'=>$site_path.'/health-accountant/accountant-list',
			'controller'=>"HealthAccountant");
			...
			'page_link'=>$site_path.'/health-product/product-list',
			'controller'=>"HealthProduct");
			...
			'page_link'=>$site_path.'/health-store/sell-record',
			'controller'=>"HealthStore");
			...
			'page_link'=>$site_path.'/health-newsletter/setting',
			'controller'=>"HealthNewsletter");
			...
			'page_link'=>$site_path.'/health-message/compose-message');
			
			//---------NEW MENU LINK START------------------ 
			$access_right['notice'] =array('menu_icone'=>'notice.png' ,'menu_title'=>'Notice',
			'controller'=>"HealthNotice",
			'action'=>'',
			...
			'page_link'=>$site_path.'/health-notice/notice-list');
			...
			'page_link'=>$site_path.'/health-nutrition/nutrition-list');
			
			//---------NEW MENU LINK START------------------ 
			$access_right['reservation'] =array('menu_icone'=>'reservation.png' ,'menu_title'=>'Event',
			'controller'=>"HealthReservation",
			'action'=>'',
			...
			'page_link'=>$site_path.'/health-reservation/reservation-list');
			...
			'page_link'=>$site_path.'/HealthSubscriptionHistory/');
			...
			$sql = "TRUNCATE TABLE health_accessright";
			$stmt = $conn->execute($sql);	
			
			$entities = $this->HealthAccessright->newEntities($rows);
			foreach($entities as $entity)
			{
				if($this->HealthAccessright->save($entity))
