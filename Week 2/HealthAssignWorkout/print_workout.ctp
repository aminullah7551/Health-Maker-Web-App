...
<div class="">
	...
	<?php echo "<h4>".$session["display_name"]."'s ". __('Workouts') ."</h4>"; ?>
		<hr />
		<div class="box-body">
		<?php
			...
			{?>
				...
				foreach($row as $day=>$value)
				{
					...
					?>
						...
						<div class="col-md-2 col-sm-2 col-xs-2 day_name"><?php echo __($day);?></div>
						<div class="col-md-10 col-sm-10 col-xs-10">
						<?php foreach($value as $r)
							{?>
							<div class="col-md-12 col-sm-12 col-xs-12">
							<span class="col-md-3 col-sm-3 col-xs-3"><?php echo $this->Health->get_activity_by_id($r["workout_name"]);?></span>   
