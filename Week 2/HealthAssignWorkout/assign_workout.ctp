	...
	<div class="col-md-12 box box-default">		
		<div class="box-header">
			<section class="content-header">
			  ...
			  <ol class="breadcrumb">
				<a href="<?php echo $this->Health->createurl("HealthAssignWorkout","workoutLog");?>" class="btn btn-flat btn-custom"><i class="fa fa-bars"></i> <?php echo __("Workout Logs");?></a>
			  </ol>
			</section>
		</div>
		<hr>
		...
		<div class='form-group'>
			...
			<div class="col-md-6 module_padding">
				...
				?>
			<input type="hidden" id="getcategory" data-url="<?php echo $this->request->base;?>/HealthAjax/getCategoriesByMember" >
			</div>
			<?php if($session["role_name"] == "administrator"){ ?>
			<div class="col-md-3">
				<a href="<?php echo $this->request->base;?>/HealthMember/addMember" class="btn btn-default btn-flat"><?php echo __("Add Member");?></a>
			</div>
			<?php } ?>
		</div>		
		<div class='form-group'>
			...
			<div class="col-md-3">
				<a href="#" class="btn btn-default btn-flat level-list" data-url="<?php echo $this->request->base;?>/HealthAjax/levelsList"><?php echo __("Add Level");?></a>
			</div>
		</div>		
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-sm-10 border">
				...
				<div class="col-md-3">
					...
					<?php foreach ($this->Health->days_array() as $key=>$name)
					{ ?>
		...
		<input type="hidden" id="add_workout_url" value="<?php echo $this->request->base;?>/HealthAjax/gmgt_add_workout">
		<div class='clear'>
		<br><br>
		<?php 
		$this->Form->end();
			...
			{?>
				<div class="panel panel-default workout-block" id="remove_panel_<?php echo $data;?>">				
				  <div class="panel-heading">
					<i class="fa fa-calendar"></i> <?php echo __("Start From")." <span class='work_date'>".$this->Health->get_db_format(date($this->Health->getSettings("date_format"),strtotime($row["start_date"])))."</span> ".__("TO")." <span class='work_date'>".$this->Health->get_db_format(date($this->Health->getSettings("date_format"),strtotime($row["end_date"])))."</span>";?>
					<span class="del_panel" del_id="<?php echo $data;?>" data-url="<?php echo $this->request->base;?>/HealthAjax/deleteWorkoutData/<?php echo $data;?>"><i class='fa fa-times-circle' aria-hidden="true"></i></span>
				  </div>
				  <br>
				...
				foreach($row as $day=>$value)
				{
					...
					?>
						...
						<?php foreach($value as $r)
							{?>
							<div class="col-md-12">
							<span class="col-md-3 col-sm-3 col-xs-12"><?php echo $this->Health->get_activity_by_id($r["workout_name"]);?></span>   
