	...
	<div class="col-md-12 box box-default">		
		<div class="box-header">
			<section class="content-header">
			  ...
			  <ol class="breadcrumb">
				<a href="<?php echo $this->Health->createurl("HealthAttendance","Attendance");?>" class="btn btn-flat btn-custom"><i class="fa fa-plus"></i> <?php echo __("Member Attendance");?></a>
			 </ol>
			</section>
		</div>
		<hr>
		...
		<form method="post" class="validateForm">  
			  ...
			  <div class="form-group col-md-3">
				<label class="control-label" for="curr_date"><?php echo __("Date");?></label>				
					<input id="curr_date" class="form-control validate[required] date" type="text" value="<?php echo (isset($_POST['curr_date'])) ? $this->Health->get_db_format(date($this->Health->getSettings("date_format"),strtotime($attendance_date))): $this->Health->get_db_format(date($this->Health->getSettings("date_format")))?>" name="curr_date">
			 </div>		
	...
	?>
		...
		<div class="panel-body panel-staff">  
         ...
         <div class="panel-heading" style="padding-bottom: 25px; ">
         	...
         	<?php echo __("Staff Attendance, Date");?> : <?php echo (isset($_POST['curr_date'])) ? $this->Health->get_db_format(date($this->Health->getSettings("date_format"),strtotime($attendance_date))):"";?></h4>
         </div>
		 <br><br>
			<div class="clearfix"> </div>
        ...
        <table class="table">
           ...
           <tr>
            ...
            <tr> 
				...
				<td><?php echo  $this->Health->get_attendance_status_staff($row["id"],$_POST["curr_date"]);?></td>
			</tr>
	  <?php } ?>
			</tbody>
		</table>
