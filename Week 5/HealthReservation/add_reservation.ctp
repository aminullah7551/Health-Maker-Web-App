...
$(document).ready(function() {
	...
	if($edit)
	{?>
	$( ".date" ).datepicker( "setDate", new Date("<?php echo date($this->Health->getSettings("date_format"),strtotime($data['event_date'])); ?>" ));
	<?php } ?>
	...
	<div class="col-md-12 box box-default">		
		<div class="box-header">
			<section class="content-header">
			  ...
			  <ol class="breadcrumb">				
				<a href="<?php echo $this->Health->createurl("HealthReservation","reservationList");?>" class="btn btn-flat btn-custom"><i class="fa fa-bars"></i> <?php echo __("Event List");?></a>
			  </ol>
			</section>
		</div>
		<hr>
		...
		<?php
			...
			echo "<a href='javascript:void(0)' data-url='{$this->request->base}/HealthAjax/EventPlaceList' id='eventplace_list' class='btn btn-flat btn-default'>".__("Add or Remove")."</a>";
			echo "</div>";	
			echo "</div>";			
