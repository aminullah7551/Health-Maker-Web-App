	...
	<div class="col-md-12 box box-default">		
		<div class="box-header">
			<section class="content-header">
			  ...
			  <ol class="breadcrumb">
				<a href="<?php echo $this->Health->createurl("HealthProduct","productList");?>" class="btn btn-flat btn-custom"><i class="fa fa-bars"></i> <?php echo __("Product List");?></a>
			 </ol>
			</section>
		</div>
		<hr>
		...
		<div class="col-md-6">
			<div class='input-group'>
				<span class='input-group-addon'><?php echo $this->Health->get_currency_symbol();?></span>
