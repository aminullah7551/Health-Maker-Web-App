	...
	<div class="col-md-12 box box-default">		
		...
		<div class="row">
			...
			<div class="col-md-5 col-sm-4 col-xs-12 no-padding text-center" style="margin-top: 20px;">
				...
				$birthday = $this->Health->get_db_format($date->format($this->Health->getSettings("date_format")));
			...
			<div class="col-md-4 no-padding border">	
					...
					<tr>
						...
						<td class="txt_color"><?php echo $this->Health->get_db_format(date($this->Health->getSettings("date_format"),strtotime($data['membership_valid_to'])));?></td>
					</tr>
					<tr>
						<th><i class="fa fa-graduation-cap"></i>&nbsp;&nbsp;<?php echo __("Classes");?></th>
						<td class="txt_color"><?php echo $this->Health->get_class_by_member($data["id"]);
						//echo $data['id'];?></td>
					</tr>
					<tr>
						<th><i class="fa fa-heart"></i>&nbsp;&nbsp;&nbsp;<?php echo __("Interest Area");?></th>
						<td class="txt_color"><?php echo $data['health_interest_area']['interest'];?></td>
					</tr>	
					<tr>
						<th><i class="fa fa-user"></i>&nbsp;&nbsp;&nbsp;<?php echo __("Staff Member");?></th>
						<td class="txt_color"><?php echo $this->Health->get_staff_name($data['assign_staff_mem']);?></td>
					</tr>
					...
					<tr>
						...
						<td class="txt_color"><?php echo $this->Health->get_group_by_member($data["id"]);?></td>
					</tr>					
				</table>
			</div>
		</div>
		...
		<div class="row view_detail view_member_detail">
			...
			<span class="report_title">
				...
				<a href="<?php echo $this->request->base ."/HealthDailyWorkout/add_measurment/{$data['id']}/Weight";?>" class="btn btn-flat btn-danger right"> <?php echo __("Add Weight");?></a>
			<?php } ?>
			</span>			
			...
			<span class="report_title">
				...
				<?php $role = $this->request->session()->read('User.role_name');?>
				<?php if($role != 'accountant'){ ?>		
				<a href="<?php echo $this->request->base ."/HealthDailyWorkout/add_measurment/{$data['id']}/Waist";?>" class="btn btn-flat btn-danger right"> <?php echo __("Add Waist"); ?></a>
				<?php } ?>	
			</span>
		...
		<div class="row view_detail">
			...
			<span class="report_title">
				...
				<?php $role = $this->request->session()->read('User.role_name');?>
				<?php if($role != 'accountant'){ ?>	
				<a href="<?php echo $this->request->base ."/HealthDailyWorkout/add_measurment/{$data['id']}/Thigh";?>" class="btn btn-flat btn-danger right"><?php echo __("Add Thigh"); ?></a>
				<?php } ?>	
			</span>			
			...
			<span class="report_title">
				...
				<?php $role = $this->request->session()->read('User.role_name');?>
				<?php if($role != 'accountant'){ ?>	
				<a href="<?php echo $this->request->base ."/HealthDailyWorkout/add_measurment/{$data['id']}/Arms";?>" class="btn btn-flat btn-danger right"><?php echo __("Add Arms")?></a>
				<?php } ?>	
			</span>
		...
		<div class="row view_detail">
			...
			<span class="report_title">
				...
				<?php $role = $this->request->session()->read('User.role_name');?>
				<?php if($role != 'accountant'){ ?>	
				<a href="<?php echo $this->request->base ."/HealthDailyWorkout/add_measurment/{$data['id']}/Height";?>" class="btn btn-flat btn-danger right"><?php echo __("Add Height"); ?></a>	
			...
			<span class="report_title">
				...
				<?php $role = $this->request->session()->read('User.role_name');?>
				<?php if($role != 'accountant'){ ?>	
				<a href="<?php echo $this->request->base ."/HealthDailyWorkout/add_measurment/{$data['id']}/Chest";?>" class="btn btn-flat btn-danger right"><?php echo __("Add Chest")?></a>	
			<?php } ?>
			</span>
		...
		<div class="row view_detail">
			...
			<span class="report_title">
				...
				<?php $role = $this->request->session()->read('User.role_name');?>
				<?php if($role != 'accountant'){ ?>		
				<a href="<?php echo $this->request->base ."/HealthDailyWorkout/add_measurment/{$data['id']}/Fat";?>" class="btn btn-flat btn-danger right"><?php echo __("Add Fat"); ?></a>
			<?php } ?>
			...
			<span class="report_title">
				...
				<?php $role = $this->request->session()->read('User.role_name');?>
				<?php if($role != 'accountant'){ ?>		
				<a href="<?php echo $this->request->base ."/HealthDailyWorkout/add_measurment/{$data['id']}/Fat";?>" class="btn btn-flat btn-danger right"><?php echo __("Add Photo"); ?></a>	
			<?php } ?>
			</span>	
			<div id="fat_report" style="width: 100%; height: 250px;float:left;">
			...
			if(!empty($history))
			{
				foreach($history as $row)
				{
					echo "<tr>
							...
							<td>". $this->Health->get_currency_symbol() ." {$row["membership_amount"]}</td>
							<td>". $this->Health->get_currency_symbol() ." ". ($row["membership_amount"] - $row["paid_amount"]) ."</td>
							<td>".(($row['start_date'] != '')?$this->Health->get_db_format(date($this->Health->getSettings("date_format"),strtotime($row["start_date"]))):'Null')."</td>
							<td>".(($row['end_date'] != '')?$this->Health->get_db_format(date($this->Health->getSettings("date_format"),strtotime($row["end_date"]))):'Null')."</td>
							<td><span class='bg-primary pay_status'>".$this->Health->get_membership_paymentstatus($row["mp_id"])."</span></td>
						</tr>";
				}
			}
			?>
